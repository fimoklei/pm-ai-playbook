...
| Grill with docs                | Doc-aware grilling session that stress-tests plans against domain model, glossary, and ADRs, updating them inline | When stress-testing a plan against a project's existing terminology and documented decisions | [./meta-skills/grill-with-docs](./meta-skills/grill-with-docs)                   |
